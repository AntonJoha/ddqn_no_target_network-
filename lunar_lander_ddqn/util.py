...
class DDQNConfig:
    ...
    render: bool = False
    target_network_countdown: int = 25  # Episode countdown before dropping the target network; < 0 keeps it on.
...
def parse_args() -> DDQNConfig:
    ...
    parser.add_argument(
        ...
        type=int,
        default=25,
        help="Episode countdown before dropping the target network; use 0 for DQN and <0 to keep it on.",
    )
